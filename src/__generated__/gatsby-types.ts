...
type pageCGithubGatsbyVerion4Srcpages404Js3159585216QueryVariables = Exact<{ [key: string]: never; }>;


type pageCGithubGatsbyVerion4Srcpages404Js3159585216Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
...
type BlogPostBySlugQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly mdx: Maybe<(
    Pick<Mdx, 'id' | 'body' | 'mdxAST'>
    & { readonly frontmatter: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'description'>> }
  )> };

type staticCGithubGatsbyVerion4SrccomponentsseoTsx2841359383QueryVariables = Exact<{ [key: string]: never; }>;


type staticCGithubGatsbyVerion4SrccomponentsseoTsx2841359383Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'description'>
      & { readonly social: Maybe<Pick<Social, 'twitter'>> }
    )> }> };

type pageCGithubGatsbyVerion4SrcpagesusingTypescriptTsx2907560070QueryVariables = Exact<{ [key: string]: never; }>;


type pageCGithubGatsbyVerion4SrcpagesusingTypescriptTsx2907560070Query = { readonly site: Maybe<Pick<Site, 'buildTime'>> };
