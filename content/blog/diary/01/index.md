...
他にも色々な静的サイトジェネレータを使ってWebサイトを作ってますので、[こちらの記事](https://blog.toriwatari.work/Jamstack/01/)をご覧ください。
...
Gatsbyは最高に使いやすいので文句なくこれからも使用していくと思います。

CircleCIを使用してのCI/CDを行うのが次の目標です。
